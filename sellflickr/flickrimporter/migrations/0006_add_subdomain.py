...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlickrPhoto.subdomain'
        db.add_column('flickrimporter_flickrphoto', 'subdomain', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['subdomains.Subdomain']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlickrPhoto.subdomain'
        db.delete_column('flickrimporter_flickrphoto', 'subdomain_id')
