...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlickrUser.token'
        db.add_column('flickrimporter_flickruser', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlickrUser.token'
        db.delete_column('flickrimporter_flickruser', 'token')
