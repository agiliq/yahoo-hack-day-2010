...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flickrimporter_flickruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('flickrimporter', ['FlickrUser'])

        # Adding model 'FlickrPhoto'
        db.create_table('flickrimporter_flickrphoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flickrimporter.FlickrUser'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal('flickrimporter', ['FlickrPhoto'])


    def backwards(self, orm):
        
        # Deleting model 'FlickrUser'
        db.delete_table('flickrimporter_flickruser')

        # Deleting model 'FlickrPhoto'
        db.delete_table('flickrimporter_flickrphoto')
