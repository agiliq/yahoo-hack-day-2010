...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlickrUser.nsid'
        db.add_column('flickrimporter_flickruser', 'nsid', self.gf('django.db.models.fields.CharField')(default=0, max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlickrUser.nsid'
        db.delete_column('flickrimporter_flickruser', 'nsid')
