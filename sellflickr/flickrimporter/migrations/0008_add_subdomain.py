...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlickrUser.subdomain'
        db.add_column('flickrimporter_flickruser', 'subdomain', self.gf('django.db.models.fields.related.ForeignKey')(default='aa', to=orm['subdomains.Subdomain']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlickrUser.subdomain'
        db.delete_column('flickrimporter_flickruser', 'subdomain_id')
    ...
    models = {
        ...
        'flickrimporter.flickruser': {
            ...
            'subdomain': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['subdomains.Subdomain']"}),
