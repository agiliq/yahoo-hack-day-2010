...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FlickrUser', fields ['token']
        db.create_unique('flickrimporter_flickruser', ['token'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FlickrUser', fields ['token']
        db.delete_unique('flickrimporter_flickruser', ['token'])
